...
# ＨＥＲＥ
GV.test_data_dir = 'test_data/Images_test'  # '0322data/Train-n/Images_train' 0305_data_split  0331data/Train-n/Images_train

GV.test_labels_dir = 'test_data/test_mask'

GV.test_sobel_dir = 'test_data/Images_test'
...
def simpleNN(split):
    ...
    data, labels = L.Python(module='read_data1',
                            ...
                            param_str=str(dict(split=split,
                                               ...
                                               train_sobel_dir='0408data1/Images_train_SOBEL',
                                               train_labels_dir='0408data1/GT_train',
                                               test_data_dir=GV.test_data_dir,  #
                                               test_sobel_dir=GV.test_sobel_dir,
                                               # test_sobel_dir='0408data1/Images_train_SOBEL',
...
GV.test_dir = 'test_data/Images_test'
GV.target_data_dir = '.'
GV.target_dir = GV.target_data_dir
if __name__ == '__main__':
    # make_net()
    #GV.phase = 'test'
    '''
    f4_lr_0.1_0408_pyloss_data_sal_split_first5times_pyloss_plus_num_finalout16_only_sal_Loss_ks3_HardNeg_crop_nout32_repeat2_batch5_dilation1_1e-8_iter_110000    
    f4_lr_0.1_0408_pyloss_data_sal_split_first5times_pyloss_plus_num_finalout16_only_metric_Loss_ks3_HardNeg_crop_nout32_repeat2_batch5_dilation1_1e-8_iter_110000    
    f4_lr_0.1_0408_pyloss_data_sal_split_first5times_pyloss_plus_num_finalout16_two_Loss_ks3_HardNeg_crop_nout32_repeat2_batch5_dilation1_1e-8_iter_110000    
    '''
    ...
    weight = '/workspace/model/snapshot/' + str(snapshot_name) + '.caffemodel'

    state = '/workspace/model/snapshot/' + str(snapshot_name) + '.solverstate'
    ...
    if GV.phase == 'test':
        ...
        net = caffe.Net(str(test_dir), str(weight), caffe.TEST)
    #            dsd
    #    store_curve_to_mat(snapshot_name, train_dir, test_dir)
        net.forward()
        for p in range(GV.test_images_num):
            print('now is Number:',p)
            net.forward()
